# yelp_sentiment
A comprehensive exploration of the Yelp reviews dataset, including interesting insights, trends, patterns, as well as develop a statistical model that analyzes the sentiment of customers on this platform.
